...
initial_skills = [InitialSkill('会计', '', 5),
                  ...
                  InitialSkill('信用评级', '', 0),
                  InitialSkill('克苏鲁神话', '', 0),
                  InitialSkill('乔装', '', 5),
                  InitialSkill('闪避', '', 0),
                  InitialSkill('汽车驾驶', '', 20),
                  InitialSkill('电气维修', '', 10),
                  InitialSkill('电子学 Ω', '', 1),
                  InitialSkill('话术', '', 5),
                  InitialSkill('格斗:', '斗殴', 25),
                  fighting_initial_skills,
                  fighting_initial_skills,
                  InitialSkill('射击:', '手枪', 20),
                  firearms_initial_skills,
                  firearms_initial_skills,
                  InitialSkill('急救', '', 30),
                  InitialSkill('历史', '', 5),
                  InitialSkill('恐吓', '', 15),
                  InitialSkill('跳跃', '', 20),
                  language_initial_skills,
                  language_initial_skills,
                  language_initial_skills,
                  mother_language_initial_skill,
                  InitialSkill('法律', '', 5),
                  InitialSkill('图书馆使用', '', 20),
                  InitialSkill('聆听', '', 20),
                  InitialSkill('锁匠', '', 1),
                  InitialSkill('机械维修', '', 10),
                  InitialSkill('医学', '', 1),
                  InitialSkill('自然学', '', 10),
                  InitialSkill('导航', '', 10),
                  InitialSkill('神秘学', '', 5),
                  InitialSkill('操作重型机械', '', 1),
                  InitialSkill('说服', '', 10),
                  pilot_initial_skills,
                  InitialSkill('精神分析', '', 1),
                  InitialSkill('心理学', '', 10),
                  InitialSkill('骑术', '', 5),
                  science_initial_skills,
                  science_initial_skills,
                  science_initial_skills,
                  InitialSkill('妙手', '', 10),
                  InitialSkill('侦察', '', 25),
                  InitialSkill('潜行', '', 20),
                  survival_initial_skills,
                  survival_initial_skills,
                  InitialSkill('游泳', '', 20),
                  InitialSkill('投掷', '', 20),
                  InitialSkill('追踪', '', 10),
                  special_initial_skills,
                  knowledge_initial_skills]
